...
- Install the latest version using pnpm: `pnpm add @sparkjsdev/spark@2.0.0`, or update your project's `package.json` to the latest Spark 2.0 release: `"@sparkjsdev/spark": "^2.0.0"`.
